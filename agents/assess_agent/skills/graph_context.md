...
name: graph_context
description: >
  Knows when and how every agent should use Neo4j lineage graph data.
...
Used by: **reconcile_agent**, **orchestrator_agent**
...
Used by: **assess_agent**, **convert_agent**
...
- Include `migration_wave` in the result for orchestrator_agent wave ordering

---

## UDF handling with high blast radius

Used by: **convert_agent**
...
### reconcile_agent — borderline confidence decision
...
### deploy_agent — upstream prerequisite check
