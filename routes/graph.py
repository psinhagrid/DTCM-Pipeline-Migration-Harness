...
async def build_graph():
    ...
    from subagents.assess_subagent.utils.hql_utils import parse_file, compute_score, classify, EFFORT
    from subagents.assess_subagent.tools.scan_repo_tool import scan_repo_tool
    from subagents.assess_subagent.tools.lineage_extract_tool import lineage_extract_tool
    from subagents.assess_subagent.tools.neo4j_write_graph_tool import neo4j_write_graph_tool
